...
# --- Web UI ---
st.set_page_config(page_title="InvTrack - Invoice Monitor", layout="wide")
st.markdown(f"<h1 style='text-align: center; color: {BRAND_COLOR};'>📊 InvTrack - Integrated Invoice Monitor</h1>", unsafe_allow_html=True)
...
with st.expander("➕ Add New Invoice"):
    with st.form("entry_form", clear_on_submit=True):
        ...
        with c2:
            ...
            new_hod = st.selectbox("Department (HOD)", hod_options)
...
if not st.session_state.master_df.empty:
    ...
    if selected_invoices:
        ...
        draft = f"Subject: [Follow-up] Pending Invoice Documents - InvTrack System\n\nDear {recipients_str},\n\nI hope you are doing well.\n\nPlease find the list of pending invoices requiring validation in your department. Prompt processing will ensure our financial cycles remain efficient:\n\n{items_list}\nThank you for your cooperation.\n\nRegards,\nFinance Operations Team"
        st.text_area("Message Draft:", draft, height=300)
